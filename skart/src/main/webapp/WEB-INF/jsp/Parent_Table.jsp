...
<script src="${baseURL}/resources/scripts/parent.jtable.js"
	type="text/javascript"></script>
...
<body>
	...
	<div >
		...
		<form id="abc" action="${baseURL}/parent/exportexcel" method="post">
			<button id="excel" class="abc" type="submit">
				<img src="resources/img/icon_excel.png"> Download Excel
			</button>
		</form>
		<form id="abc" action="${baseURL}/parent/exportpdf" method="post">
	...
	<div>
		...
		<div id="ParentTableContainer" style="width: 1100px;"></div>
