...
<div class=" row" >
    <div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="Student Details"  href="#">
            <img src="${conPath}/resources/img/student-details.jpg"> </img>
	...
	<div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="Employee Details"  href="#">
            <img src="${conPath}/resources/img/employee.png"> </img>
	...
	<div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="Parent Details"  href="#">
            <img src="${conPath}/resources/img/parents.png"> </img>
            <div><strong> &nbsp; &nbsp; Parent Details</strong></div>
...
<div class=" row">
	<div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="Students Attendance"  href="#">
            ...
            <div><strong>Students Attendance</strong></div>
	...
	<div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="Employee Attendance"  href="#">
            <img src="${conPath}/resources/img/teacher_attendance.png"> </img>
            <div><strong>Employee Attendance</strong></div>
            
        </a>
    </div>

	<div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="Class Timetable"  href="#">
            <img src="${conPath}/resources/img/timetable.png"> </img>
            <div><strong>Class Timetable</strong></div>
...
<div class=" row">
	<div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="Exams Schedule"  href="#">
            <img src="${conPath}/resources/img/examshedule.png"> </img>
            <div><strong>Exams Schedule</strong></div>
            
        </a>
    </div>

	<div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="News"  href="#" >
            <img src="${conPath}/resources/img/news.jpg"> </img>
	...
	<div class="col-md-2 col-sm-3 col-xs-6" style="position:relative; left: 100px;">
        <a data-toggle="tooltip" title="Settings"  href="#">
            <img src="${conPath}/resources/img/setting.jpg"> </img>
